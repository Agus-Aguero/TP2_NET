...
namespace UI.Desktop
{
    public partial class formListaUsuarios : Form
    {
        ...
        private void GenerarColumnas()
        {
            ...
            DataGridViewTextBoxColumn colNroTel = new DataGridViewTextBoxColumn();
            colNroTel.Name = "telefono";
            colNroTel.HeaderText = "Telefono";
            colNroTel.DataPropertyName = "telefono";
            colNroTel.DisplayIndex = 0;
            this.dgvUsuarios.Columns.Add(colNroTel);
